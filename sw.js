const CACHE_VERSION = 'gesundheitsapp-v31';
...
const CORE_ASSETS = [
  ...
  './css/styles.css?v=31',
  './js/data.js?v=31',
  './js/content/foods.js?v=31',
  './js/content/recipes.js?v=31',
  './js/content/exercises.js?v=31',
  './js/content/sessions.js?v=31',
  './js/content.js?v=31',
  './js/knowledge.js?v=31',
  './js/logic.js?v=31',
  './js/app/core.js?v=31',
  './js/app/screens-start.js?v=31',
  './js/app/ernaehrung.js?v=31',
  './js/app/wissen.js?v=31',
  './js/app/training.js?v=31',
  './js/app/tracker.js?v=31',
  './js/app/coach.js?v=31',
  './js/app/play3d.js?v=31',
  './js/app/main.js?v=31',
  './manifest.json',
  './icons/icon.svg',
  './icons/icon-192.png',
