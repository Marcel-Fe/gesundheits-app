const CACHE_VERSION = 'gesundheitsapp-v34';
...
const CORE_ASSETS = [
  ...
  './css/styles.css?v=34',
  './js/data.js?v=34',
  './js/content/foods.js?v=34',
  './js/content/recipes.js?v=34',
  './js/content/exercises.js?v=34',
  './js/content/sessions.js?v=34',
  './js/content.js?v=34',
  './js/knowledge.js?v=34',
  './js/logic.js?v=34',
  './js/app/core.js?v=34',
  './js/app/screens-start.js?v=34',
  './js/app/ernaehrung.js?v=34',
  './js/app/wissen.js?v=34',
  './js/app/training.js?v=34',
  './js/app/tracker.js?v=34',
  './js/app/coach.js?v=34',
  './js/app/play3d.js?v=34',
  './js/app/main.js?v=34',
  './manifest.json',
  './icons/icon.svg',
  './icons/icon-192.png',
