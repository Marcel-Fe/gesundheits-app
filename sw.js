const CACHE_VERSION = 'gesundheitsapp-v32';
...
const CORE_ASSETS = [
  ...
  './css/styles.css?v=32',
  './js/data.js?v=32',
  './js/content/foods.js?v=32',
  './js/content/recipes.js?v=32',
  './js/content/exercises.js?v=32',
  './js/content/sessions.js?v=32',
  './js/content.js?v=32',
  './js/knowledge.js?v=32',
  './js/logic.js?v=32',
  './js/app/core.js?v=32',
  './js/app/screens-start.js?v=32',
  './js/app/ernaehrung.js?v=32',
  './js/app/wissen.js?v=32',
  './js/app/training.js?v=32',
  './js/app/tracker.js?v=32',
  './js/app/coach.js?v=32',
  './js/app/play3d.js?v=32',
  './js/app/main.js?v=32',
  './manifest.json',
  './icons/icon.svg',
  './icons/icon-192.png',
