const CACHE_VERSION = 'gesundheitsapp-v35';
...
const CORE_ASSETS = [
  ...
  './css/styles.css?v=35',
  './js/data.js?v=35',
  './js/content/foods.js?v=35',
  './js/content/recipes.js?v=35',
  './js/content/exercises.js?v=35',
  './js/content/sessions.js?v=35',
  './js/content.js?v=35',
  './js/knowledge.js?v=35',
  './js/logic.js?v=35',
  './js/app/core.js?v=35',
  './js/app/screens-start.js?v=35',
  './js/app/ernaehrung.js?v=35',
  './js/app/wissen.js?v=35',
  './js/app/training.js?v=35',
  './js/app/tracker.js?v=35',
  './js/app/coach.js?v=35',
  './js/app/play3d.js?v=35',
  './js/app/main.js?v=35',
  './manifest.json',
  './icons/icon.svg',
  './icons/icon-192.png',
