const CACHE_VERSION = 'gesundheitsapp-v29';
...
const CORE_ASSETS = [
  ...
  './css/styles.css?v=29',
  './js/data.js?v=29',
  './js/content/foods.js?v=29',
  './js/content/recipes.js?v=29',
  './js/content/exercises.js?v=29',
  './js/content/sessions.js?v=29',
  './js/content.js?v=29',
  './js/knowledge.js?v=29',
  './js/logic.js?v=29',
  './js/app/core.js?v=29',
  './js/app/screens-start.js?v=29',
  './js/app/ernaehrung.js?v=29',
  './js/app/wissen.js?v=29',
  './js/app/training.js?v=29',
  './js/app/tracker.js?v=29',
  './js/app/coach.js?v=29',
  './js/app/main.js?v=29',
  './manifest.json',
  './icons/icon.svg',
  './icons/icon-192.png',
