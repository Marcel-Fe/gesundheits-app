const CACHE_VERSION = 'gesundheitsapp-v36';
...
const CORE_ASSETS = [
  ...
  './css/styles.css?v=36',
  './js/data.js?v=36',
  './js/content/foods.js?v=36',
  './js/content/recipes.js?v=36',
  './js/content/exercises.js?v=36',
  './js/content/sessions.js?v=36',
  './js/content.js?v=36',
  './js/knowledge.js?v=36',
  './js/logic.js?v=36',
  './js/app/core.js?v=36',
  './js/app/screens-start.js?v=36',
  './js/app/ernaehrung.js?v=36',
  './js/app/wissen.js?v=36',
  './js/app/training.js?v=36',
  './js/app/tracker.js?v=36',
  './js/app/coach.js?v=36',
  './js/app/play3d.js?v=36',
  './js/app/figure3d.js?v=36',
  './js/app/main.js?v=36',
  './manifest.json',
  './icons/icon.svg',
  './icons/icon-192.png',
