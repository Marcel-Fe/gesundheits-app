const CACHE_VERSION = 'gesundheitsapp-v28';
...
const CORE_ASSETS = [
  ...
  './css/styles.css?v=28',
  './js/data.js?v=28',
  './js/content/foods.js?v=28',
  './js/content/recipes.js?v=28',
  './js/content/exercises.js?v=28',
  './js/content/sessions.js?v=28',
  './js/content.js?v=28',
  './js/knowledge.js?v=28',
  './js/logic.js?v=28',
  './js/app/core.js?v=28',
  './js/app/screens-start.js?v=28',
  './js/app/ernaehrung.js?v=28',
  './js/app/wissen.js?v=28',
  './js/app/training.js?v=28',
  './js/app/tracker.js?v=28',
  './js/app/coach.js?v=28',
  './js/app/main.js?v=28',
  './manifest.json',
  './icons/icon.svg',
  './icons/icon-192.png',
